...
def main(sc, filename):
    ...
    try:
        ...
        filter_resultsA = flat_json.filter(filter_results)

        results_data = filter_resultsA.map(get_results)
        ...
        # response_m = client.put_object(
        #         Bucket='dsci6007-final-project-3nf',
        #         Body='',
        #         Key=timestamp_file + '_meeting_table'
        #         )

        # meeting_data.saveAsTextFile("s3a://dsci6007-final-project-3nf/meeting_table/meeting_table")
        meeting_data.saveAsTextFile('s3a://dsci6007-final-project-3nf/meeting_table/' + str(timestamp_file) + '_meeting_table/')
        ...
        #         Bucket='dsci6007-final-project-3nf',
        #         Body='',
        #         Key=timestamp_file + '_organizer_table'
        #         )

        # organizer_data.saveAsTextFile("s3a://dsci6007-final-project-3nf/organizer_table/organizer_table")
        organizer_data.saveAsTextFile('s3a://dsci6007-final-project-3nf/organizer_table/' + str(timestamp_file) + '_organizer_table/')
        ...
        category_data.saveAsTextFile('s3a://dsci6007-final-project-3nf/category_table/' + str(timestamp_file) + '_category_table/')
        ...
        # response_mt = client.put_object(
        #         Bucket='dsci6007-final-project-3nf',
        #         Body='',
        #         Key=timestamp_file + '_meeting_topic_table'
        #         )

        # meeting_topic_data.saveAsTextFile("s3a://dsci6007-final-project-3nf/meeting_topic_table/meeting_topic_table")
        meeting_topic_data.saveAsTextFile('s3a://dsci6007-final-project-3nf/meeting_topic_table/' + str(timestamp_file) + '_meeting_topic_table/')

        meeting_topic_tuple_data = meeting_topic_data.map(make_tuples)

        # response_mtt = client.put_object(
        #         Bucket='dsci6007-final-project-3nf',
        #         Body='',
        #         Key=timestamp_file + '_meeting_topic_tuple_table'
        #         )
        ...
        meeting_topic_tuple_data.saveAsTextFile('s3a://dsci6007-final-project-3nf/meeting_topic_tuple_table/' + str(timestamp_file) + '_meeting_topic_tuple_table/')
